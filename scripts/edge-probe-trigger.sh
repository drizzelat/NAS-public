#!/bin/sh
# Dispatch the edge access policy probe every 6h — GitHub's own `schedule:` cron drops
# most slots. Docs: docs/runbooks/setup-operations/edge-access-policy-probe.md
set -eu

REPO="drizzelat/NAS"
WORKFLOW="edge-access-policy.yml"
REF="main"
...
LOG=/var/log/edge-probe-trigger.log
